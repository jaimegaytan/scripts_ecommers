describe('Prueba de integración con la API', () => {
  it('Enviar dos solicitudes en paralelo', () => {
    // Solicitud 1
    const token = '49kCY9kjBsDMr4_XAtJoHAVt7DI';
    const request1 = cy.request({
      
      method: 'POST',
      url: 'https://api.c2yi-servicios1-s1-public.model-t.cc.commerce.ondemand.com/flexicommercewebservices/v2/flexi/producteca/startorder', 
      headers: {
